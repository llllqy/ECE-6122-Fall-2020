...
Description:
It is the ECE_UDPSocket.h class
*/
#pragma once
#include <thread>
#include <list>
...
public:
	...
	bool getNextMessage(udpMessage& message);
	//ini sending  func
	void sendMessage(const std::string& strTo, unsigned short usPortNum, const udpMessage& message);
	...
	//process and add source to message
	void processMessage();
	void addSource();
